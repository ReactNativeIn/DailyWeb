				...
				<div id="productInfo" class="row">
					...
					<div class="col-md-6">
						<ul id="productInfoUl">
							...
							<li class="productInfoLi"><a href="${contextPath}/list/남녀공용?list=popular">인기상품</a></li>
							<li class="productInfoLi"><a href="${contextPath}/list/남녀공용?list=high">높은가격</a></li>
							<li class="productInfoLi"><a href="${contextPath}/list/남녀공용?list=low">낮은가격</a></li>
							<li class="productInfoLi"><a href="${contextPath}/list/남녀공용?list=new">최신상품</a></li>
						</ul>
					</div>
				</div>
